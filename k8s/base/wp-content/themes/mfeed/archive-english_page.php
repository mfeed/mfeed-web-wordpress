<?php get_header('english');?>
    ...
    <section class="mfeed-cont-wrapper-introduction d-flex" data-section-name="introduction">
      ...
      <div class="col-12">
        <div class="slider single-item">
          <div class="col-lg-6">
            ...
            <p class="h5 mb-4">We will provide the place and solutions, and will continue to create innovative values.</p>
            <a class="btn btn-mfeed my-3 d-block d-md-inline-block" href="/en/about/">
              READ MORE
            </a>
          </div>
          <!--<div class="col-lg-6">
...
<section class="mfeed-cont-wrapper-service" data-section-name="service">
  ...
  <g class="color2">
    ...
    <path d="M85.6,52.6c.1.3.1.6-.1.7H78.6a.4.4,0,0,1-.1-.6.1.1,0,0,1,.1-.1h.7c1.2-.1,1.4-.4,2.1-2.8l3.1-9.8c.5-1.6.5-1.9-.4-2.1h-1a.5.5,0,0,1,.1-.7l4.4-.2a8.2,8.2,0,0,1,5.1,1.1,3.5,3.5,0,0,1,1.7,3.3,4.9,4.9,0,0,1-4.2,4.7,10.3,10.3,0,0,1-3,.4.4.4,0,0,1-.1-.6h0a5.1,5.1,0,0,0,4.5-5.1,2.7,2.7,0,0,0-2.4-2.9h-.5c-.7,0-.7.2-1,.9L84.2,49.7c-.6,2.1-.7,2.7.6,2.8Z"/>
            ...
            <h3 class="service-subtitle text-white my-4">Internet Exchange Service</h3>
            <p class="service-descripiton text-white my-4">JPNAP(Japan Network Access Point), provided in Tokyo and Osaka, is a Layer 2 Internet eXchange (IX) service that enables stable exchanges of large-volume traffic in today's age of broadband.</p>
            <a href="https://www.jpnap.net/en/" class="btn btn-secondary mx-auto">More Info...</a>
          </div>
        </div>
  ...
  <g class="color3">
    <path d="M295.5,58c-2.1-1-8.8-2.7-20.4-5.2s-19.4-5.3-23.6-8.3-6.4-6.3-6.4-10c0-5.5,4.1-9.9,12.2-13.3s18.9-5.1,32.3-5.1,24.3,1.1,34.6,4a46.5,46.5,0,0,0-83,39.1c14.3,6.6,31.6,6.5,40.9,6.5,10.9,0,16.4-1.5,16.4-4.4Q298.5,59.5,295.5,58Z"/>
		<path d="M331,35.5c-14.1-7.2-31.5-8.2-42.5-8.2-8.2,0-12.2,1.5-12.2,4.6,0,.8.8,1.6,2.6,2.4s8.2,2.4,19.6,4.9,19.4,5.4,24.1,8.7,7.1,6.9,7.1,10.9c0,6.2-3.8,11-11.4,14.3s-18.4,5.1-32.5,5.1-25.2-1-37-3.9a46.4,46.4,0,0,0,83.5-28A44.3,44.3,0,0,0,331,35.5Z"/>
            ...
            <h3 class="service-subtitle text-white my-4">IPv6 Internet Connection Service</h3>
            <p class="service-descripiton text-white my-4">transix is a service for ISPs that provides IPv6 Internet access using the IPoE method. This service is only available in Japan.</p>
  ...
  <g class="color1">
-1.055a6.3,6.3,0,0,0,.539-.836,3.983,3.983,0,0,0,.281-.656,1.777,1.777,0,0,0,.086-.516.55.55,0,0,0-.391-.555,3.555,3.555,0,0,0-1.187-.148v-1.312h7.078v1.313a2.723,2.723,0,0,0-1.055.211,4.676,4.676,0,0,0-1.016.594,9.2,9.2,0,0,0-1.047.938q-.539.555-1.164,1.258l-4.641,5.219,6.75,9.406a9.215,9.215,0,0,0,1.773,1.914,2.852,2.852,0,0,0,1.742.648h.063V0H26a22.71,22.71,0,0,1-2.641-.125,5.753,5.753,0,0,1-1.734-.453,3.989,3.989,0,0,1-1.227-.883,12.086,12.086,0,0,1-1.117-1.414l-5.516-7.906-2.719,2.2v4.938a2.881,2.881,0,0,0,.211,1.2,1.68,1.68,0,0,0,.563.7,2.019,2.019,0,0,0,.836.32,6.374,6.374,0,0,0,1.016.078h.422V0H4.777V-1.344h.406a6.906,6.906,0,0,0,1.008-.07A2.21,2.21,0,0,0,7.027-1.7a1.516,1.516,0,0,0,.57-.648,2.586,2.586,0,0,0,.211-1.133V-19.328A2.586,2.586,0,0,0,7.6-20.461a1.626,1.626,0,0,0-.57-.664,2.06,2.06,0,0,0-.836-.3,6.906,6.906,0,0,0-1.008-.07H4.777v-1.344h9.313V-21.5h-.422a6.374,6.374,0,0,0-1.016.078,2.019,2.019,0,0,0-.836.32,1.68,1.68,0,0,0-.562.7,2.881,2.881,0,0,0-.211,1.2v9.031ZM28.143,0V-1.344h.406a6.332,6.332,0,0,0,1.023-.078,2.076,2.076,0,0,0,.836-.32,1.6,1.6,0,0,0,.563-.7,2.979,2.979,0,0,0,.2-1.2V-19.2a2.979,2.979,0,0,0-.2-1.2,1.6,1.6,0,0,0-.562-.7,2.076,2.076,0,0,0-.836-.32,6.332,6.332,0,0,0-1.023-.078h-.406v-1.344h9.312V-21.5h-.422a6.374,6.374,0,0,0-1.016.078,2.019,2.019,0,0,0-.836.32,1.68,1.68,0,0,0-.562.7,2.881,2.881,0,0,0-.211,1.2V-3.641a2.881,2.881,0,0,0,.211,1.2,1.68,1.68,0,0,0,.563.7,2.019,2.019,0,0,0,.836.32,6.374,6.374,0,0,0,1.016.078h.422V0Z" transform="translate(37.456 22.844)"/>
            ...
            <a href="/en/rpki/" class="btn btn-secondary mx-auto py-1">More Info...</a>
          </div>
        </div>
        <div class="col-md-6 pl-md-5 pt-5 pt-md-0 sector-style">
          <div class="inner-hook d-flex flex-column justify-content-between text-center">
  ...
  <g class="color2" transform="translate(-1129.44 -107.319)">
    <path d="M110.134-.32,99.687-13.308V-.32H98.016v-16H99.4L109.9-3.191V-16.32h1.671v16Zm11.765,0h-1.671V-14.791h-5.953V-16.32h13.576v1.529H121.9Zm14.235-16a7.382,7.382,0,0,1,3.2.659,5.051,5.051,0,0,1,2.153,1.859,5.054,5.054,0,0,1,.765,2.776,5.2,5.2,0,0,1-.788,2.859,5.15,5.15,0,0,1-2.224,1.906,7.758,7.758,0,0,1-3.318.671h-3.694V-.32h-1.671v-16Zm-.071,9.2A4.847,4.847,0,0,0,139.357-8.2a3.561,3.561,0,0,0,1.247-2.824,3.373,3.373,0,0,0-1.247-2.729,4.99,4.99,0,0,0-3.294-1.035h-3.835V-7.12Z" transform="translate(1128 125.64)"/>
            ...
            <h3 class="service-subtitle my-4">NTP for Public<br>(Japanese)</h3>
...
<section class="mfeed-cont-wrapper-latestnews" data-section-name="latestnews">
  <div class="container">
    <div class="row">
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During Interop Tokyo 2026, as a contribution, JPNAP will connect to ShowNet with 400G.<br>
                          For more information about Interop Tokyo 2026 ShowNet, please visit<a class="archive-article-title font-weight-normal" href="https://www.interop.jp/2026/en/shownet/"> here.</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During JANOG56, for network support, JPNAP will connect to the venue network with 10G.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During Interop Tokyo 2025, as a contribution, JPNAP will connect to ShowNet with 100G. For more information about Interop Tokyo 2025 ShowNet, please visit
                          <a class="archive-article-title font-weight-normal" href="https://www.interop.jp/2025/en/shownet/"> here.</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During JANOG55, for network support, JPNAP will connect to the venue network with 10G.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During CEDEC+KYUSHU 2024, JPNAP will connect to the venue Wi-Fi network with 10G.
                        </a>
                      </h2>
                    </header>
                  </article>
                 ...
                 <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During JANOG54, for network support, JPNAP will connect to the venue network with 10G.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During Interop Tokyo 2024, as a contribution, JPNAP will connect to ShowNet with 100G. For more information about Interop Tokyo 2024 ShowNet, please visit
                          <a class="archive-article-title font-weight-normal" href="https://www.interop.jp/2024/en/shownet/"> here.</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          We are pleased to announce the expansion of the JPNAP RPKI Public ROA Cache Server, currently operating in West Japan, to include East Japan as well. For details, please visit
                          <a class="archive-article-title font-weight-normal" href="https://www.mfeed.ad.jp/en/rpki/tech.html"> here.</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          We are pleased to announce the upgrade of the JPNAP RPKI Public ROA Cache Server, operational since 2014, with the latest RPKI advancements for enhanced user experience. For details, please visit
                          <a class="archive-article-title font-weight-normal" href="https://www.mfeed.ad.jp/en/rpki/tech.html"> here.</a>
                        </a>
                      </h2>
                    </header>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          <a class="archive-article-title font-weight-normal" href="https://www.janog.gr.jp/meeting/janog50/ix%E7%9B%B8%E4%BA%92%E6%8E%A5%E7%B6%9A%E5%AE%9F%E8%A8%BC%E5%AE%9F%E9%A8%93%E3%82%92%E9%80%9A%E3%81%98%E3%81%A6%E8%A6%8B%E3%81%88%E3%81%A6%E3%81%8D%E3%81%9F400g%E5%B0%8E%E5%85%A5%E3%81%A7%E3%80%8C/">An article which features Asia's First Internet-exchange Interconnection using 400 Gigabit Ethernet was published as a hot topic on a website of JANOG50 meeting which is a largest meeting for network developers and operators (Written only in Japanese).</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          We are happy to share that we have published this video<br>
                          <object><a class="archive-article-title font-weight-normal" href="https://www.youtube.com/watch?v=NvtqySias1I">&emsp;https://www.youtube.com/watch?v=NvtqySias1I</a></object><br>
                          featuring IXP work in Japan.<br>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          JPNAP started business collaboration with PCCW Global Ltd. It enables remote-peering on JPNAP Tokyo via Console Connect provided by PCCW Ltd. For more information, please visit
                          <a class="archive-article-title font-weight-normal" href="https://www.consoleconnect.com/2021/07/pccw-global-launches-on-demand-access-to-leading-ix-platforms-through-console-connect/"> here.</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          ■Our business operation under COVID-19 outbreak<br>
                          With the cancellation of the state of emergency in Japan, we have resumed inquiry desk by phone as usual in addition to e-mail. We may change the operation again depends on cases in the future.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          ■The JANOG50 meeting will be hosted by INTERNET MULTIFEED CO.<br>
                          INTERNET MULTIFEED CO., known as the operator of JPNAP and transix, will host the JANOG's 50th meeting on 13th to 15th July 2022, in Hakodate city, Hokkaido, Japan.<br>
                          JANOG, JApan Network Operators Group, has held its meeting twice a year since 1997. The 50th meeting is memorable one to celebrate its quarter century history, and it is a great honor for us to be the host of the JANOG50 meeting.<br>
                          We have always been supporting JANOG activities since it started, and will continuously contribute to the JANOG community and the growth of the global internet.<br>
                          Looking forward to seeing many people in internet community at JANOG meetings!<br>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                        JPNAP started business collaboration with NTT Ltd. At NTT Ltd.'s Bangkok 2 Data Center, NTT Ltd. has announced the new service that international inter-connection
                        between Bangkok Neutral Internet eXchange (BKNIX) and JPNAP Tokyo. It enables remote-peering to JPNAP Tokyo from all of the BKNIX Point of Presence (PoP)
                        including NTT Ltd.'s Bangkok 2 Data Center. For more information, please visit
                        <a class="archive-article-title font-weight-normal" href="https://hello.global.ntt/en-us/newsroom/ntt-establishes-its-bangkok-2-data-center-as-international-network-exchange-hub"> here.</a>
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          JPNAP RouteFEED service implemented RPKI ROV on all route server platform. This improves the security of route exchange between RouteFEED customers.
                          JPNAP will continue our efforts to improve internet routing security.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          JPNAP Tokyo RouteFEED service started "RPKI-enabled Route Server Trial". We introduced the route server on JPNAP Tokyo which implements RPKI,
                          and provide RPKI ROV to our customers who can cooperate with us. If you would like to try RPKI-enabled route server, please contact JPNAP customer support.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          JPNAP Tokyo started to provide the service via Megaport Marketplace. It enables remote-peering on JPNAP Tokyo via the Megaport SDN.
                        </a>
                      </h2>
                    </header>
                  </article>
                ...
                <li class="list-group-item">
                  <article class="archive-article archive-article-for-top archive-type-post">
                    <header class="archive-article-header">
                      ...
                      <h2 itemprop="name">
                        <a class="archive-article-title font-weight-normal">
                          During Interop Tokyo 2019, as a contribution, JPNAP will connect to ShowNet with 100G.
                        </a>
                      </h2>
                    </header>
                  </article>
